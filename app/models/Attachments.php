...
//obsoleted by AttachmentController (but still used..)
class Attachments {

    //still used by viewer/uploadattachments which is then used by goc-tx (should be updated to use /attachment controller)
