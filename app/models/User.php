...
class User
{
    ...
    private function lookupDN($dn)
    {
      ...
      if($_SESSION["session_login"]==""){
        ...
        slog("session login is NOTt:" + $_SESSION["session_login"]);
	...
	if($sso_id_last!=""){
	  ...
	  if($row_sso2) {
        ...
        slog("session login is set:" + $_SESSION["session_login"]);

	$this->dn_id =  $_SESSION["sso_dn_id"];
	$this->contact_id = $_SESSION["sso_contact_id"];
	$this->contact_name = $_SESSION["sso_contact_name"];
	$this->contact_email = $_SESSION["sso_contact_email"];
